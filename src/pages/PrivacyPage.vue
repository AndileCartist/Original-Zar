      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to originalzar.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to originalzar, accessible from
            <a
              href="http://www.originalzar.co.za"
              rel="external nofollow noopener"
              target="_blank"
              >http://www.originalzar.co.za</a
            >
          </p>
        </li>
        <li>
...
.background {
  ...
  background-image: radial-gradient(#f5f5f5 1px, transparent 1px),
    radial-gradient(#7e7e80 1px, #e6e6e6 1px);
